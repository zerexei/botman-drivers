...
// https://chats.viber.com/smicaos-ai-chat

// https://github.com/TheArdent/botman-viber-driver
...
class ViberDriver extends  HttpDriver
{
    ...
    public function matchesRequest()
    {
        return in_array(false, [
            $this->isConfigured(),
            $this->payload->get('event') === 'message',
            $this->getSenderId(),
            $this->getReceiverId(),
            $this->getMessageText()
        ]);
    ...
    {
        return (string) ($this->event->get('message')['text'] ?? '');
    }
    ...
    {
        return (string) ($this->event->get('sender')['id'] ?? '');
    }
}
